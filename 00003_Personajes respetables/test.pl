...
test('Solo Marsellus, Vincent y Winston son respetables', set(PersonajesPosibles = [pumkin, honeyBunny, jules, mia, butch, bernardo, bianca])):-
  personajesRespetables(PersonajesRespetables), 
  member(Personaje, PersonajesPosibles),
